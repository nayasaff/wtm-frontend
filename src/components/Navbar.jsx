...
const Navbar = () => {
  ...
  const navigation =
    role === "admin"
      ? [
          ...
          { name: "Jobs", href: "/viewJobs", current: false },
          { name: "Registered Users", href: "#", current: false },
  ...
  if (["/signup", "/login"].includes(location.pathname)) return <div></div>;
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route exact path="viewJobs" element={<AdminJobs/>}></Route>
        <Route exact path="applications" element={<Applications/>}></Route>
        <Route path="applications/:jobId" element={<JobApplications/>}></Route>
      </Routes>
    </>
  );
};
